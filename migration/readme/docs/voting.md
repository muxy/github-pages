...
* *poll\_name*  is a developer-defined string that identifies the poll. By convention, this is a lower-case, hyphen-separated alphanumeric string.  All votes sent to this poll are counted towards the results. Prefix the name with "global" to create an [extension-wide](#extension-wide-votes) poll.
  ...
  "codes": [
    {
      ...
      "language": "javascript",
      "name": "Submit a vote in a new or existing poll"
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    ...
    "h-1": "Meaning",
    "0-0": "`mean`",
    "0-1": "The average of all the votes cast in this poll. A floating-point number.",
    "1-0": "`sum`",
    "1-1": "The sum of all the values cast in this poll.",
    "2-0": "`stddev`",
    "2-1": "An approximate standard deviation of all the votes cast in this poll. A floating-point number.",
    "3-0": "`specific`",
    "3-1": "Captures the number of votes cast with the integer values between 0 and 31, inclusive. \nThe number of votes cast for such a value is stored in the array at the index of that value. That is, the number of votes cast for the integer value `12` can be found in `specific[12]`.",
    "4-0": "`count`",
    "4-1": "The number of users who have voted.",
    "5-0": "`vote`",
    "5-1": "The value of the vote that the current user cast. Absent if the user has not yet cast a vote."
  },
  "cols": 2,
  "rows": 6
}
  ...
  "codes": [
    {
      ...
      "language": "javascript",
      "name": "Submit a vote to a new or existing global poll"
    }
  ]
}
[/block]
