...
slug: "pin-auth"
excerpt: "A game often needs to associate its currently running instance with the stream channel that the game is being streamed on. Muxy provides a simple, text-based linking scheme that can be used by a broadcaster."
hidden: true
metadata: 
  image: []
  robots: "index"
