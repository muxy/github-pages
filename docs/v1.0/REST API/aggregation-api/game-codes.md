...
title: "Game Codes"
slug: "game-codes"
excerpt: "The Game Code system provides a way to reward viewers with game or [DLC](https://en.wikipedia.org/wiki/Downloadable_content) codes."
hidden: true
metadata: 
  image: []
  robots: "index"
createdAt: "Tue Oct 26 2021 21:28:57 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Wed Nov 10 2021 23:17:58 GMT+0000 (Coordinated Universal Time)"
---
...
```json Names of active code sets
{
  "names": ["Pistol Skin", "Fancy Hat"]
}
```
...
```json Number of codes distributed from each set
{
...
```shell Make a list of users eligible
