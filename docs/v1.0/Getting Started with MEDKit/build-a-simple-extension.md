...
excerpt: "Add source for a Hello World extension to your basic installation"
hidden: false
metadata: 
  image: []
  robots: "index"
createdAt: "Wed Sep 15 2021 17:18:52 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Mon Dec 06 2021 21:28:31 GMT+0000 (Coordinated Universal Time)"
---
...
2. Add a text input box and button to this extension so that a broadcaster will be able to enter some message text, and press the button to publish the message to all current viewers. 
   ...
   **[See the commented Broadcaster Live Dashboard code here](../../v1.0/Getting Started with MEDKit/build-a-simple-extension/create-a-broadcaster-panel.md)**
...
4. Use the example code to modify another extension that viewers will see. This code subscribes to the broadcast stream and displays messages when they arrive. New viewers who visit the channel will see the most recent message the broadcaster sent. 
   ...
   **[See the commented code for the Viewer Panel Extension here](../../v1.0/Getting Started with MEDKit/build-a-simple-extension/create-a-viewer-panel.md)**
