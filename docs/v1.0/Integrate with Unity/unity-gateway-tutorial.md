...
updatedAt: "Fri Nov 10 2023 21:47:39 GMT+0000 (Coordinated Universal Time)"
---
...
**_karlaplan is just the example name for the coins. Streamers can name their coins whatever they want!_**
...
_The image above is from Renfield: Bring Your Own Blood option menu. Notice the Muxy Gateway button at the bottom. _

![](https://files.readme.io/e147abd-Screen_4_-_Paste_Pin_Ctrl_V.png)

_The image above is the authentication menu for the game Renfield: Bring Your Own Blood. The broadcaster places their PIN code from the Muxy Gateway Twitch Extension configuration page. _
