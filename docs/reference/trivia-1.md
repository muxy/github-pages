...
description: Archived Muxy documentation for Trivia Contest Management.
slug: trivia-1
product: REST API
audience: developers
status: archived
...
```shell title="Vote for an option"
